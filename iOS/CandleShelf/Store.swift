...
final class Store: ObservableObject {
    ...
    private let fileName = "candleshelf_items.json"
    ...
    /// Adding sub-log entries (Burn Rotation) is the Pro feature.
    @discardableResult
    ...
    static func seedItems() -> [Item] {
        [
        Item(name: "Balsam Fir", primaryField: "40 hrs", secondaryField: "", notes: "Woodsy, best for evenings"),
        Item(name: "Vanilla Bean", primaryField: "55 hrs", secondaryField: "", notes: "Warm, pairs with citrus"),
        Item(name: "Sea Salt & Sage", primaryField: "30 hrs", secondaryField: "", notes: "Fresh, good for daytime"),
        ]
    }
}
